                ...
                <div class="row g-3">
                    ...
                    <!--Nombre-->
                     ...
                     <div class="col-md-6 mb-2">
                        ...
                        <input type="file" name="img_path" id="img-path" class="form-control" accept="Image/*">
                        @error('img_path')
                       <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <select data-size="4" title="Seleccione una Presentacion" data-live-search="true" name="presentacion_id" id="presentacion_id" class="form-control selectpicker show-tick">
