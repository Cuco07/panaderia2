                    ...
                    <td>
                      <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                        ...
                        <form action="{{route('productos.edit',['producto' =>$item]) }}" method="get">
                          ...
                          @else
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"  data-bs-target="#confirModal-{{$item->id}}">Restaurar</button>
                          @endif
                    ...
                    <div class="modal fade" id="confirModal-{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {{ $item->estado = 1 ? '¿Seguro deseas eliminar el producto?' : '¿Seguro deseas restaurar el Producto?' }}                              
                                </div>
